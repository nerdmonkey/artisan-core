...
from handlers.evaluation import main


@patch("handlers.evaluation.env")
@patch("handlers.evaluation.logger")
def test_main(mock_logger, mock_env):
    ...
    mock_logger.info.assert_any_call("Hello, from Spartan Framework")
